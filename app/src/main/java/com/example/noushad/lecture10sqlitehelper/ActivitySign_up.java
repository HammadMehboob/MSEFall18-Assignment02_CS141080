package com.example.noushad.lecture10sqlitehelper;
...
public class ActivitySign_up extends AppCompatActivity {
        ...
        else
        {
            ...
            alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent = new Intent(ActivitySign_up.this, MainActivity.class);
